...
login().then(()=>{
  ...
  setProperties(elRef1, {"string1":"https://web-embeddables.vercel.app/profile-1.jpg","string2": "Rohit Kumar Dogra","json1":[{"label":"Software Developer","clickable":false,"id":"Software Developer"}],"json2":[{"label":"Mobile Phone","value":"+91-8968422868","clickable":true,"id":"mobile-link"},{"label":"Email","value":"rohit.kumardogra@servicenow.com","clickable":true,"id":"email-link"},{"label":"City","value":"Bangalore"},{"label":"State","value":"Karnatka"}]});
   const elRef2 =  document.getElementById("cmp2");
  setProperties(elRef2, {"string1":"https://web-embeddables.vercel.app/profile-2.jpg","string2": "Test User","json1":[{"label":"Software Developer 2","clickable":false,"id":"Software Developer"}],"json2":[{"label":"Mobile Phone","value":"+91-8968422862","clickable":true,"id":"mobile-link"},{"label":"Email","value":"test.kumardogra@servicenow.com","clickable":true,"id":"email-link"},{"label":"City","value":"Bangalore"},{"label":"State","value":"Karnatka"}]});
